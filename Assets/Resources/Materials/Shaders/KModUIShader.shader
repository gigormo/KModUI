Shader "Custom/KModMainUIShader"
{
    Properties
    {
        ...
        _IsPressed ("Is Pressed", Range(0,1)) = 0.0
        _IsFill ("Is Fill", Range(0,1)) = 0.0
    }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 _Color;
            float _TimeScale, _ShouldAnimate, _IsPressed, _IsFill;
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                if (borderMask >= 0.02 && borderMask < 0.99)
                {
                    ...
                    for (float j = 0.0; j < 24.0; j++)
                    {
                        ...
                        if (_IsFill > 0.9){
                            //d /= smoothstep(0.16, 0.9, borderMask);
                    ...
                    return float4(finalColor, texColor.a) * lerp(texColor, _Color, flicker);
                }
